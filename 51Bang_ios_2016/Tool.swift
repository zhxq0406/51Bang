...
let Bang_URL_Header = "http://bang.xiaocool.net/index.php?g=apps&m=index&a="
let Bang_Image_Header = "http://bang.xiaocool.net/uploads/images/"
...
func removeOptionWithString(str:NSString)->String{
